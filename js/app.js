...
var catView = {
    ...
    init: function() {
        ...
        this.adminButton = document.getElementById('admin-toggle');
        this.adminDiv = document.getElementById('admin-section');
        ...
        this.adminButton.addEventListener('click', function(){
            var state = octopus.getAdminStatus()
            console.log(state)
            if(state === false){
